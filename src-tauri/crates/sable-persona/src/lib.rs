//! # sable-persona
//!
//! The persona policy engine for the Sable AI coding harness.
//!
//! This crate defines how Sable communicates and approaches problems.
...
//!
//! ```rust
//! use sable_persona::{PersonaPolicy, PersonaIntensity};
//!
